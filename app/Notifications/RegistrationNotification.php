...
class RegistrationNotification extends Notification  implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->line(Lang::get('Your new ' . config('app.name') . ' Account has been created. Now you can login to  ' . config('app.name') . '  to start earning'))
            ->line(Lang::get('Your username: ') . $notifiable->username)
